...
var isFavorite;
if (isFavorite = true) {
  console.log("My favorite  is food is  " + food + "!");
} else {
...
var vegetables = ["carrots", "celery", "cucumbers", "lettuce", "beets"]
...
// different fruits.
var fruits = ["mango", "apple", "banana", "orange", "melon"]
